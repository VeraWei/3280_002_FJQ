...
class Page  {
    ...
    ?>
        ...
        <section class="main">
        <h2>Current Data - <?php echo count($reservations); ?> rows </h2>
        <table>
            <thead>
                <tr>
            ...
            <?php
                ...
                foreach($reservations as $reservation)  {
                    ...
                    echo '<td><a href="' . $_SERVER['PHP_SELF'] . '?action=edit&id='.$reservation->getReservationId().'">Edit</a></td>';
                    echo '<td><a href="' . $_SERVER['PHP_SELF'] . '?action=delete&id='.$reservation->getReservationId().'">Delete</a></td>';
                    echo "</tr>";
                } 
                    ...
                    <tr>
                        ...
                        <?php
                            foreach ($facilities as $facility)   {
                                ...
                                $selected = ($facility->getFacilityID()==$reservationToEdit->getFacilityID()) ? "Selected": "";
