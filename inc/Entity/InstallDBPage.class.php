    ...
    { ?>
        <div class="container">  
            ...
            <form id="dbsettings" action="" method="post">
                ...
                <fieldset>
                <legend>Host:</legend>
                <input type="text" name="db_host" tabindex="1" placeholder="MySQL Host IP/DNS" required autofocus>
                </fieldset>
                <fieldset>
                <legend>Port:</legend>
                <input type="text" name="db_port" tabindex="2" placeholder="MySQL Port" required >
                </fieldset>
                <fieldset>
                <legend>Username:</legend>
                <input type="text" name="db_user" tabindex="3" placeholder="MySQL username" required >
                </fieldset>
                <fieldset>
